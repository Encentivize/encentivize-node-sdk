...
var members={
    ...
    getReward: function(options,callback) {
        var url="/v1/members/{memberId}/availableRewards/{rewardId}";
        options.verb="get";
        options.url=url;

        makeRestRequest(options,callback);
    },
    redeemReward: function(options,callback) {
        var url="/v1/members/{memberId}/redeemReward";
        options.verb="post";
        options.url=url;
